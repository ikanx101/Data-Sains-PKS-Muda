...
Sekarang kita akan mulai masuk ke bahasa pemrograman untuk mengatasi
masalah-masalah di data sains.

Mungkin teman-teman bertanya:

> Kenapa sih harus pakai bahasa pemrograman segala? Kenapa gak pakai
> Excel saja?

Karena *traditional tools* semacam Ms. Excel tidak mampu melakukan
beberapa hal ini:

1.  Mengolah data gambar, *geolocation*, dan teks.
2.  Mengolah data dalam jumlah besar.
3.  *Reproducible*: kemampuan untuk mereproduksi pekerjaan ke *dataset*
    lainnya.

-----

<img src="all you can eat.jpg" width="60%" style="display: block; margin: auto;" />

**Bayangkan Anda berada di restoran *all you can eat* dimana semua
makanan yang Anda mau ada semua di sana…**
...
Nah, untuk *training* PKS muda, kita akan menggunakan **R** secara
*cloud service* pada situs [Google Colab](http://colab.to/r).
...
Silakan menuju ke situs ini: [Google Colab](http://colab.to/r).
